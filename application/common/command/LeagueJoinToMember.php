...
class LeagueJoinToMember extends Command
{
    protected function configure()
    {
        $this->setName('LeagueJoinToMember')->setDescription('团员审核表信息迁移最终表');
    }
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $join_data = Db::name('league_join')->where('status','in',['0', '3'])->chunk(200,function($j_data){
            ...
            Db::name('league_member')->insertAll($j_data, false);
        });
